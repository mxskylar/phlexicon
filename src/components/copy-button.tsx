...
// https://icons.getbootstrap.com/icons/clipboard-check-fill/
const COPIED_ICON = (
...
export class CopyButton extends React.Component<Props, State> {
    ...
    render() {
        const copyButtonClass = this.state.copied ? "btn-outline-success" : "btn-outline-dark";
        return (
            <button
                type="button"
                ...
                onClick={e => this.copy()}
            >
                {this.state.copied ? COPIED_ICON : COPY_ICON} 
            </button>
        );
    }
}